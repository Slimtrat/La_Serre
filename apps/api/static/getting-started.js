(() => {
  const STORAGE_KEY = "serre-studio-getting-started-v0.2.13";
  ...
  const UI_COPY = {
    fr: {
      brand: "Bien démarrer", subtitle: "PARCOURS SUR LE GRAPHE · STUDIO 0.2.13",
    ...
    en: {
      brand: "Getting started", subtitle: "LIVE GRAPH TOUR · STUDIO 0.2.13",
  ...
  function shouldAutoOpen() {
    try {
      ...
      if (document.body.dataset.workspaceView === "guided") return false;
