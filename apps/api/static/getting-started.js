(() => {
  const STORAGE_KEY = "serre-studio-getting-started-v0.2.3";
  const STEP_COUNT = 5;
  let dialog = null;
  let currentStep = 0;
  let furthestStep = 0;
    ...
    dialog.innerHTML = `
      <section class="getting-started-shell">
        <header class="getting-started-heading">
          <div class="getting-started-brand"><span>SV</span><div><strong>Bien démarrer</strong><small>LA SERRE DES VENINS · STUDIO 0.2.3</small></div></div>
